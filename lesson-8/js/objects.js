...
const person = {
    ...
    age: 19,
    gender: "male",
    interests: ["Movies", "Gaming", "Eating"],
    greeting() {
            let greeting = `Hi, my name is ${this.name.first} and I am ${this.age} year old.One of my interest id ${this.interest[1]}.` ;
            return greeting;
    }
};
