...
for (let i = 0; i < myArray.length; i ++ ) {
    //chech if array element is an array 
...
let orig6 = ` Toronto Maple Leafs, chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montreal Canadiens, New yoork Rangers`;
...
orig6length = orig6Array.push("Buffalo Sabres", "Philadephia Flyers");
